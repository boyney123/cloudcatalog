...
// ];
// const subCategories = [
//   { name: 'AWS Lambda (2)', href: '#' },
//   { name: 'Amazon EventBridge (0)', href: '#' },
// ];
// const filters = [
//   {
//     id: 'owners',
//     name: 'Owners',
//     options: [{ value: 'dboyne', label: 'David Boyne', checked: false }],
//   },
//   {
//     id: 'Service',
//     name: 'Service',
//     options: [{ value: 'user-service', label: 'Users Services', checked: false }],
//   },
// ];
...
export default function Resources({ resources }: Props) {
  ...
  const [renderedResources, setRenderedResources] = useState(resources);
          ...
          <section aria-labelledby="products-heading" className="pb-24 pt-6">
            ...
            <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
              ...
              <div className="lg:col-span-4">
                <ResourceGrid resources={renderedResources} />
              </div>
            </div>
          </section>
        </main>
