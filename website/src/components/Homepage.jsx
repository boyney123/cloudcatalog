import { ArrowDownTrayIcon, ChevronRightIcon, DocumentIcon, GlobeAmericasIcon, GlobeEuropeAfricaIcon, UserGroupIcon } from '@heroicons/react/20/solid';
...
const features = [
  {
    ...
    description: 'Use the CloudCatalog CLI to import resources directly into your Catalog.',
    icon: CloudArrowUpIcon,
  },
  {
    name: 'Static website',
  ...
  },
  {
    ...
    description: 'Create users and teams in your Catalog. Assign them resources or services.',
    icon: UserGroupIcon,
  },
  {
    name: 'Powered by markdown',
    description: 'Every resource is a markdown file, you can add as much detail as you want with supported CloudCatalog components.',
    icon: DocumentIcon,
  },
  {
            ...
            <div className="mx-auto max-w-2xl">
              <div className="max-w-lg">
                ...
                <h1 className="mt-10 text-4xl font-extrabold tracking-tight text-gray-900 sm:text-6xl">
                  Documentation tool for <span className="text-orange-500">AWS Architectures</span>
                </h1>
                <p className="mt-6 text-lg leading-8 text-gray-600">
                  CloudCatalog is an Open Source project that helps you document your <span className="text-orange-400 font-bold">resouces</span>,{' '}
                  <span className="text-orange-400 font-bold">services</span> and <span className="text-orange-400 font-bold">owners</span>.
                  <p className="text-xs mt-3">Powered by markdown, components and CLI tools.</p>
                </p>
                <div className="mt-6 flex items-center gap-x-6">
                  ...
                  <a href="/docs/overview/intro" className="text-sm font-semibold leading-6 text-gray-900">
                  ...
                  <div className="mx-auto max-w-2xl md:mx-0 md:max-w-none">
                    <div className="w-screen overflow-hidden rounded-tl-xl bg-gray-900">
                      ...
                      <div className="-mt-1 text-xs">
                        <PrismSyntaxHighlighter style={codeStyle} language={'markdown'} wrapLines className="overflow-auto">
                          {ExampleCode}
      ...
      <div className="bg-gray-100 py-24 ">
        <div className="mx-auto max-w-7xl">
          <div className="mx-auto max-w-2xl sm:text-center">
            <h2 className="text-base font-semibold leading-7 text-orange-600">Start documenting in minutes</h2>
            {/* <p className="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">CLI tools designed to help</p> */}
            <p className="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Static site generator for your architecture</p>
            <p className="mt-6 text-lg leading-8 text-gray-600">
              Import your AWS resources into CloudCatalog powered by the <span className="text-gray-800 font-bold">@cloudcatalog/cli</span>.
            </p>
          </div>
        </div>
        <div className="relative overflow-hidden pt-16">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <img src="/img/screenshot.png" alt="App screenshot" className="mb-[-12%] rounded-xl shadow-2xl ring-1 ring-gray-900/10" width={2432} height={1442} />
          ...
          <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2">
            <div className="lg:ml-auto lg:pl-4 lg:pt-4">
              <div className="lg:max-w-lg">
                <h2 className="text-base font-semibold leading-7 text-orange-600">Resources</h2>
                <p className="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Import AWS resources</p>
                <p className="mt-6 text-lg leading-8 text-gray-600">
                  Import and document your AWS resources directly into your Catalog. Use markdown to document your resources and enrich them with custom MDX components.
                </p>
                <div className="mt-8">
                  <a
            ...
            <div className="flex items-start justify-end lg:order-first">
              <img src="/img/screenshot.png" alt="Product screenshot" className="w-[48rem] max-w-none rounded-xl shadow-xl ring-1 ring-gray-400/10 sm:w-[57rem]" width={2432} height={1442} />
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2 lg:items-start">
            <div className="lg:pr-4 lg:pt-4">
              <div className="lg:max-w-lg">
                <h2 className="text-base font-semibold leading-7 text-orange-600">Ownership</h2>
                <p className="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Create users and teams</p>
                <p className="mt-6 text-lg leading-8 text-gray-600">
            ...
            <img src="/img/teams.png" alt="Product screenshot" className="w-[48rem] max-w-none rounded-xl shadow-xl ring-1 ring-gray-400/10 sm:w-[57rem] md:-ml-4 lg:ml-0" width={2432} height={1442} />
          </div>
        </div>
      </div>
            ...
            <div className="w-full max-w-2xl xl:max-w-none xl:flex-auto xl:px-16 xl:py-24">
              <figure className="relative isolate pt-6 sm:pt-12">
                ...
                <blockquote className="text-xl font-semibold leading-8 text-white sm:text-2xl sm:leading-9">
                  <p>Documentation is often overlooked and often required to help scale teams and understand domains. CloudCatalog was built to help you document your AWS architectures.</p>
                </blockquote>
                <figcaption className="mt-8 text-base">
                  <div className="font-semibold text-white"><a href="https://twitter.com/boyney123" className="text-blue-400">David Boyne | @boyney123</a></div>
                  <div className="mt-1 text-gray-400">Developer Adovate @ AWS - Creator of EventCatalog and CloudCatalog</div>
                </figcaption>
              </figure>
            </div>
          </div>
        ...
        <div className="bg-white">
          <div className="mx-auto max-w-7xl px-6 pt-24 sm:pt-32 lg:flex lg:items-center lg:justify-between lg:px-8">
            <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">
              Ready to start using <span className="text-orange-500 font-bold">CloudCatalog?</span>
              <br />
